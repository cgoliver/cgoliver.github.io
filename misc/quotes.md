...
-- Fyodor Dostoevsky, *The Brothers Karamazov* <button onclick="Copy(1)"></button>
...
-- Fyodor Dostoevsky, *The Brothers Karamazov* <button onclick="Copy(2)"></button>

<div id="3">
</div>
In the mouth of the foolish is a rod of pride: but the lips of the wise shall preserve them.  
-- Proverbs 14:3 <button onclick="Copy(3)"></button>
...
-- CS Lewis, *Surprised By Joy* <button onclick="Copy(4)"><button>
