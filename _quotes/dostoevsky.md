...
-- Fyodor Dostoevsky, *The Brothers Karamazov* <button onclick="Copy('dostoevsky', 'dost-miracles')">[copy link]</button>
...
-- Fyodor Dostoevsky, *The Brothers Karamazov* <button onclick="Copy('dostoevsky', 'dost-socialism')">[copy link]</button>
...
-- Fyodor Dostoevsky, *The Eternal Husband* <button onclick="Copy('dostoevsky', 'dost-monster')">[copy link]</button>
