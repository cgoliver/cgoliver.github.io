...
* Discouraging 'free riders', i.e. those who do simply not want to bear the risks of contributing to herd immunity yet reap the its benefits.
...
This means that in our day to day lives we all accept a non=zero degree of danger (usually involuntary) that is the price we pay for the freedom of others.
In other words, in no way are we accustomed or generall accep the principle that one ought to *minimize* their risk unto to others.
...
On the contrary, the only principle to justify coercion in this case is exactly the self defeating pseudo-principle that 'one ought to strictly *minimize* their risk to others'.

Therefore the level of risk to others which allows for the general public to benefit from the enjoyment of life is acceptable.
